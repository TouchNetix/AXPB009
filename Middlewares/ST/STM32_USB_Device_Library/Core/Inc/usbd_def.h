...
typedef struct
{
  ...
  //CUSTOMISED {
  uint8_t  *(*GetInterfaceStrDescriptor)( USBD_SpeedTypeDef speed , uint16_t *length, uint8_t interface_num);
  // }
...
// CUSTOMISED -  forward declarations
struct          _USBD_GENERIC_HID_HandleTypeDef;
typedef struct  _USBD_GENERIC_HID_HandleTypeDef     USBD_GENERIC_HID_HandleTypeDef;
typedef struct  _USBD_GENERIC_HID_Itf               USBD_GENERIC_HID_ItfTypeDef;
...
typedef struct _USBD_HandleTypeDef
{
  ...
  // CUSTOMISED - added USB handle fields
  USBD_GENERIC_HID_HandleTypeDef    *pClassDataGENERIC;
