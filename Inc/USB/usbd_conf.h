...
#define USBD_MOUSE_REL_REPORT_DESC_SIZE         (266) //(52)      blob = 19
#define USBD_MOUSE_REL_REPORT_DESC_SIZE_LO      (LOBYTE(USBD_MOUSE_REL_REPORT_DESC_SIZE))
#define USBD_MOUSE_REL_REPORT_DESC_SIZE_HI      (HIBYTE(USBD_MOUSE_REL_REPORT_DESC_SIZE))
