...
#define TPAD_REPORT_DESC_CONTACT_LENGTH         (62U)
#define TPAD_REPORT_DESC_SCAN_TIME_LENGTH       (25U)
#define USBD_TPAD_REPORT_DESC_SIZE              (171 + \
                                             (PRECISION_TPAD_MAX_CONTACT_CT * TPAD_REPORT_DESC_CONTACT_LENGTH) + \
                                             (TPAD_REPORT_DESC_SCAN_TIME_LENGTH))
#define USBD_TPAD_REPORT_DESC_SIZE_LO           (LOBYTE(USBD_TPAD_REPORT_DESC_SIZE))
#define USBD_TPAD_REPORT_DESC_SIZE_HI           (HIBYTE(USBD_TPAD_REPORT_DESC_SIZE))
