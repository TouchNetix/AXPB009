...
#define USB_DEVICE_MAJOR_VERSION                (0x13)
#define USB_DEVICE_MINOR_VERSION                (0x38) // these are both BCD, e.g. 0x12 means .12
...
#define DEVICE_MODE_PID_RELATIVE_MOUSE          (0x2F08u)
...
#define USBD_INTERFACE_ABS_MOUSE_ON_STRING_FS   "AXPB009 Abs. Mouse"
#define USBD_INTERFACE_REL_MOUSE_ON_STRING_FS   "AXPB009 Rel. Mouse"
